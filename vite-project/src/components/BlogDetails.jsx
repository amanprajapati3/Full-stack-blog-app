...
const BlogDetails = () => {
  ...
  return <>
     <div className="sm:m-5">
        ...
        <img
              className="p-1 w-[600px] rounded-xl"
              src={
          ...
          />
          <span>
          <label htmlFor="" className="text-2xl font-bold p-1 font-sans">About</label> <br />
          <p className="sm:p-8 p-2 text-xl sm:w-[500px]">{blog.about}</p>
          </span>
        </div>
     </div>
     <Footer/>
