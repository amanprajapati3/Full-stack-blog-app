  ...
  return (
    <>
      <div>
        <div className="relative">
          ...
          <div className="relative  text-center  items-center pb-28 pt-16 md:pb-32 md:pt-44">
            ...
            <p className="text-white pt-5">
              Greatness in sports is built in practice, long before the game
              begins. <br /> Its the quiet, unseen grind that creates champions.
        ...
        <h1 className="font-bold font-sans py-10 text-3xl sm:text-5xl md:pl-24 text-center pb-5">
          Sports
        </h1>
