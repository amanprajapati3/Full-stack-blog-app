...
const StudyDetail = () => {
  ...
  const study_blog = blogs.filter((blog) => blog.category === "study");
  ...
  return (
    <>
      <div>
        <div className="relative">
          ...
          <div className="relative  text-center  items-center pb-28 pt-16 md:pb-32 md:pt-44">
            ...
            <p className="text-white pt-5">
              A focused mind can achieve more in one hour than a distracted one
              in five. <br /> Eliminate distractions and dive deep—quality
        ...
        <h1 className="font-bold font-sans text-3xl py-10 sm:text-5xl md:pl-24 text-center pb-5">
          Study
        </h1>
