...
const Games = () => {
  ...
  return (
    <>
     <h1 className="font-bold font-sans text-3xl  pl-24">Gaming</h1>
     <p className='text-center py-5 lg:text-xl'>Here you will get all the posted blog about the game by the creators and those who have better experience in Game</p>
