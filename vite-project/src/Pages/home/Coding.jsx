...
const Coding = () => {
  ...
  return (
    <>
     <h1 className="font-bold font-sans text-3xl pl-24">Coding</h1>
     <p className='text-center py-5 lg:text-xl'>Here you will get all the latest and useful coding blog with daily updated news and tips.</p>
