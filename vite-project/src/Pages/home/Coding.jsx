...
const Coding = () => {
  ...
  return (
    <>
     <h1 className="font-bold font-sans text-2xl pl-24">Coding</h1>
     <p className='text-center py-2'>Here you will get all the latest and useful coding blog with daily updated news and tips.</p>
