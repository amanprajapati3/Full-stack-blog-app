...
const Blogs = () => {
  ...
  return (
    ...
    <h1 className='text-2xl font-bold lg:text-3xl'>All Blogs</h1>
    <p className='text-center py-5 lg:text-xl'>Writing is not merely an act of putting words on paper, it's a journey of exploration and expression.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10  md:grid-cols-3 lg:grid-cols-4 lg:mx-20 md:mx-5 sm:mx-2 mx-2 mt-6">
            {blogs.map((blog) => {
              return (
                <div
                  key={blog._id}
                  className="border-2 border-gray-300 rounded-2xl p-2 hover:cursor-pointer"
                >
                  {" "}
