...
const Myblog = () => {
  ...
  return (
    <>
    <h1 className="text-3xl font-bold font-sans p-5">My Blog</h1>
            ...
            {blogs.map((blog) => {
              return (
                ...
                >
                  ...
                  <button className="p-2 rounded-md bg-yellow-600 hover:bg-yellow-700 active:bg-yellow-700 cursor-pointer text-white text-xl">
                    <a href={`/update/${blog._id}`}>Update</a>  
                  </button>
                  <button  onClick={() => DeleteUser(blog._id)} className="p-2 rounded-md bg-red-600 cursor-pointer hover:bg-red-700 active:bg-red-700 text-white text-xl">
                    Delete
                  </button>
                  </div>
